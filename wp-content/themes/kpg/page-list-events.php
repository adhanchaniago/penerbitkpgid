...
$count_item = wp_count_posts('event');
                ...
                <div class="col-md-4">
                  <div class=" whitebox berita-box height-auto">
                    <div class="berita-list">
                      <span class="image">
                        <img src="<?php echo $cover; ?>" onerror="this.src='<?php echo $default_event_img; ?>';">
                      </span>
              ...
              <ul class="pagination pull-right">
                <?php 
                  if($page==1)
                  {
                    ...
                    echo '<li><a href="'.get_permalink().'?page=1"><span>First</span></a></li>';
                    echo '<li><a href="'.get_permalink().'?page='.($page-1).'"><i class="fa fa-caret-left"></i></a></li>';
                  }
                 ?>
                <?php
                ...
                <?php
                  if($page==$total_page){
                    ...
                    echo '<li><a href="'.get_permalink().'?page='.($page+1).'"><i class="fa fa-caret-right"></i></a></li>';
                    echo '<li><a rel="next" href="'.get_permalink().'?page='.$total_page.'">Last</a></li>';
                  }
                ?>
              </ul>
