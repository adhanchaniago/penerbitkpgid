...
get_header(); 
$cat = get_term_by('name', single_cat_title('',false), 'book_type'); 
?>
<!-- begin top section -->
          ...
          <div class="container">
            <div class="row">
                ...
                <aside class="bip-sidebar">
                  <div class="outline-sidebar">
                    ...
                    <div class="sidebar-content">
                      <a href="?cat=<?php echo $cat->slug; ?>" class="btn btn-accent blocking">all books <i class="wd wd-sketched14"></i></a>
                      <a href="?filter=new_arrival&cat=<?php echo $cat->slug; ?>" class="btn btn-accent blocking">new books <i class="wd wd-sketched14"></i></a>
                      <a href="?filter=popular&cat=<?php echo $cat->slug; ?>" class="btn btn-accent blocking">popular books <i class="wd wd-sketched14"></i></a>
                      <a href="?filter=up_coming&cat=<?php echo $cat->slug; ?>" class="btn btn-accent blocking">upcoming books <i class="wd wd-sketched14"></i></a>
              ...
              <div class="col-md-9 col-sm-8">
              	<center><h3>Category :  <?php single_tag_title(); ?></h3></center>
                <div class="book-list">
                  <div class="grid">
                  <?php
                  wp_reset_query();
