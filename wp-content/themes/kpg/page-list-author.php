...
$count_item = wp_count_posts('book_author');
            ...
            <div class="grid-sizer"></div>
              <?php
                ...
                foreach ($book_list as $key => $value) {
                  ...
                  if($desc!='')
                  {
                    $desc = strip_tags(wp_trim_words( $desc, 5, '' ));
                  }
              ?>
                <span class="grid-item"><div class="book-item author-list list">
                  <a href="<?php echo get_permalink($value->ID); ?>">
                      <span class="cover"><img src="<?php echo $image_url; ?>" /></span>
                      <div class="overlay">
                        <div class="cover-small"><img src="<?php echo $image_url; ?>" class="img-grid" oncontextmenu="return false;" /></div>
                        <div class="info">
                          <span class="yellow"><?php echo $value->post_title; ?></span>
                        </div>
