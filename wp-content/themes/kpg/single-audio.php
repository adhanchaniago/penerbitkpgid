...
$video_mp3 = get_field('file');
$mp3_url = $video_mp3['url'];

$video_image = get_field('image');
$image_url = $video_image['url'];
// print_r($video_mp3);exit();
    ...
    <div class="clearfix row">
      <div class="col-md-8">
        <!-- book -->
          <?php
            ...
            $author_id = $book_meta['author'];
            $book_authors = array();
            foreach ($author_id as $key => $value) {
              $book_authors[] = get_post($value);
            }
            $front_cover_id = get_field('front_cover',$book[0]->ID);
            // echo "<pre>";print_r($front_cover_id);exit();
            $front_cover_url = $front_cover_id['url'];
            $author_name = array();
            if(count($book_meta['author'])>=1){
              foreach ($book_meta['author'] as $key => $value) {     
        ...
        <div class="multimedia-detail margintop-30 clearfix">
          <div class="col-md-12">
            <div class="video-box">
              <div class="video-big">
                <!-- <iframe width="680" height="413" src="<?php echo $video_url; ?>"></iframe> -->
                <img src="<?php echo $image_url; ?>" style="height: auto;">
                <audio controls>
      ...
      <div class="col-md-4">
        ...
        <div class="whitebox berita-box height-auto">
          ...
          <?php 
            if(array_key_exists(0, $article_list)): 
          ...
          <div class="whitebox berita-box height-auto">
            ...
            <div class="berita-list">
              <span class="image"><img src="<?php echo $image_url; ?>" onerror="this.src='<?php echo $default_merchandise_img; ?>';"></span>
              <h2 class="margintop-20"><?php echo $value->post_title; ?></h2>
              <p>
            ...
            <hr>
            <div class="text-center"><a href="/list-berita" class="btn grey-outline border-none no-padding no-margin">Lihat Semua Berita <i class="fa fa-caret-right" aria-hidden="true"></i></a></div>
          </div>
        <?php endif; ?>
        </div>
      </div>
